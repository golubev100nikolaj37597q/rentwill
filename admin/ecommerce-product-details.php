...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
          ...
          <div class="col-sm mb-2 mb-sm-0">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-no-gutter">
                <li class="breadcrumb-item"><a class="breadcrumb-link" href="./ecommerce-products.html">Квартиры</a></li>
                <li class="breadcrumb-item active" aria-current="page">Изменить</li>
              </ol>
            </nav>

            <h1 class="page-header-title">Изменить данные о квартире </h1>
            ...
            <div class="card mb-3 mb-lg-5">
              ...
              <div class="card-body">
                ...
                <div class="mb-4">
                  ...
                  <input type="text" class="form-control" name="productName" id="productNameLabel" placeholder="Введите название" value="<?= $info['title'] ?>" aria-label="Shirt, t-shirts, etc.">
                </div>
                <div class="mb-4">
                  ...
                  <input type="text" class="form-control" name="short_desc" id="productNameLabel" value="<?= $info['short_desc'] ?>" placeholder="Введите название" aria-label="Shirt, t-shirts, etc.">
                </div>
                <!-- End Form -->
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" name="bookingid" value="<?= $info['booking_id'] ?>" id="SKULabel" placeholder="Введите id квартиры">
                    </div>
                    <!-- End Form -->
                  </div>
                  <!-- End Col -->
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="mb-4">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" value='<?= $info['GoogleMap'] ?>' name="iframe-google-maps" id="weightLabel" placeholder="Введите iframe гугл карты">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="mb-4">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" value='<?php $info['discount'] ?>' id="discountInput" name="discount" placeholder="Введите процент скидки" disabled>
                      ...
                      <script>
                        ...
                        checkbox.addEventListener('change', function() {
                          ...
                          inputField.value = this.checked ? '' : '<?php $info['discount'] ?>';
                        });
                      </script>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="mb-4">
                  ...
                  <input type="text" class="form-control" name="adress" value="<?= $info['address'] ?>" id="vendorLabel" placeholder="Введите адрес">
                </div>
                <!-- End Form -->
                ...
                <div class="mb-4">
                  ...
                  <input type="text" class="form-control" name="max-human" value="<?= $info['max_adults'] ?>" id="tagsLabel" placeholder="Введите кол-во людей" aria-label="Enter tags here">
                </div>
                <div class="mb-4">
                  <label for="kvm" class="form-label">Квадратные метры</label>


                  <input type="text" name="kvm" class="form-control" value="<?= $info['kvm'] ?>" id="kvm" placeholder="Введите кв.м">
                </div>
                <div class="mb-4">
                  <label for="kvm" class="form-label">PlayStation 1 день</label>


                  <input type="text" name="ps-1" class="form-control" value="<?= $info['ps-1'] ?>" id="ps-1" placeholder="Введите кв.м">
                </div>
                <div class="mb-4">
                  <label for="kvm" class="form-label">PlayStation 3 дня</label>


                  <input type="text" name="ps-3" class="form-control" value="<?= $info['ps-3'] ?>" id="ps-3" placeholder="Введите кв.м">
                </div>
                <div class="mb-4">
                  <label for="kvm" class="form-label">PlayStation 7 дней</label>


                  <input type="text" name="ps-7" class="form-control" value="<?= $info['ps-7'] ?>" id="ps-7" placeholder="Введите кв.м">
                </div>
                <div class="mb-4">
                  <label for="kvm" class="form-label">Трансфер</label>


                  <input type="text" name="transfer_value" class="form-control" value="<?= $info['transfer'] ?>" id="transfer_value" placeholder="Введите кв.м">
                </div>
              </div>
              <!-- Body -->
            </div>
  ...
  <script>
    ...
    function createPriceInput(date) {
      const price_data = <?= $info['price_dates'] ?>;
      ...
      if (price_data[dateKey]) {
        input.value = price_data[dateKey];
      } else {
        input.value = 'Цена не найдена';
      }

      input.placeholder = `Дата: ${date.toLocaleDateString()}`;
      input.setAttribute("data-date", date);
      input.name = 'price_' + date.getTime();
    ...
    for (const dateStr in price_data) {
      const dateObj = new Date(dateStr);
      const formattedDate = `${dateObj.getFullYear()}-${(dateObj.getMonth() + 1).toString().padStart(2, '0')}-${dateObj.getDate().toString().padStart(2, '0')}`;
      formattedPriceData[formattedDate] = price_data[dateStr];
    }

    const defaultDates = Object.keys(formattedPriceData);
  ...
  <script>
    (function() {
      window.onload = function() {
        ...
        quillEditor.querySelector('.ql-editor').innerHTML = "<?= $info['description'] ?>";
