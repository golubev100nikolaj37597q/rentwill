  ...
  function k(p, v) {
      ...
      return (
        ...
        w.weekNumbers &&
          ...
          w.weekNumbers.insertAdjacentHTML(
            "beforeend",
            "<span class='flatpickr-day notranslate'>" + w.config.getWeek(n) + "</span>"
          ),
        De("onDayCreate", o),
        o
      );
    ...
    function K(e, n) {
      for (
        ...
        o.appendChild(R("flatpickr-day notranslate" + l, new Date(e, n - 1, s), 0, u));
      for (s = 1; s <= i; s++, u++)
        o.appendChild(R("flatpickr-day notranslate", new Date(e, n, s), 0, u));
      for (
        var f = i + 1;
        f <= 42 - t && (1 === w.config.showMonths || u % 7 != 0);
        f++, u++
      )
        o.appendChild(R("flatpickr-daynotranslate" + c, new Date(e, n + 1, f % i), 0, u));
    ...
    function oe(e, n) {
      if (
        (void 0 === n && (n = "flatpickr-day notranslate"),
        1 === w.selectedDates.length &&
          (!e ||
    ...
    function me(e) {
      ...
      var n = f(g(e), function (e) {
        return (
          e.classList &&
          e.classList.contains("flatpickr-day notranslate") &&
          !e.classList.contains("flatpickr-disabled") &&
